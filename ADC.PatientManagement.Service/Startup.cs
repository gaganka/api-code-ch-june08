...
using ADC.PatientManagement.Service.Middleware;
...
namespace ADC.PatientManagement.Service
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISearchPatientReportService, SearchPatientReportService>();
